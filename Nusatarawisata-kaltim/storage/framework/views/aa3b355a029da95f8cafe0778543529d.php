...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('images/icon/icon512_rounded.png')); ?>">
    ...
    <meta property="og:image" content="<?php echo e(asset('images/logo/nusatawan-logo.png')); ?>">
    ...
    <meta property="twitter:description"
        content="Rencanakan perjalanan wisata Anda dengan informasi destinasi dan prakiraan cuaca terintegrasi di seluruh Indonesia.">
    <meta property="twitter:image" content="<?php echo e(asset('images/logo/nusatawan-logo.png')); ?>">
    ...
    <div
        ...
        <div class="relative hidden md:block md:w-1/2 bg-gradient-to-br from-blue-500 to-blue-700">
            <div class="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-80"
                style="background-image: url('<?php echo e(asset('images/auth.png')); ?>');">
            </div>
            <div
                class="absolute inset-0 bg-gradient-to-br from-blue-600/60 to-blue-900/60 flex flex-col justify-between p-8">
                <div>
                    <img src="<?php echo e(asset('images/logo/nusatawan-logo.png')); ?>" alt="Nusatawan Logo" class="h-20">
                </div>
        ...
        <div class="md:w-1/2 p-6 md:p-12 flex items-center justify-center bg-white">
            <div class="w-full max-w-md">
                ...
                <div class="flex justify-center mb-6 md:hidden">
                    <img src="<?php echo e(asset('images/logo/nusatawan-logo.png')); ?>" alt="Nusatawan Logo" class="h-12">
                </div>
                ...
                <form method="POST" action="<?php echo e(route('auth.login')); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    <div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-600">
                        Belum punya akun?
                        <a href="<?php echo e(route('auth.register')); ?>" class="text-primary font-semibold hover:underline">
                            Daftar sekarang
                        </a>
                    </p>
                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/final-project-cloud-computing-b-cc-kelompok-8-boboiboy-kuasa-bug-gaib/Nusatarawisata-kaltim/resources/views/auth/login.blade.php ENDPATH**/ ?>